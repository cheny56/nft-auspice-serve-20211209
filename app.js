...
const MAX_FILESIZE_TO_UPLOAD= 5
var jsonParser = bodyParser.json({limit:1024*1024 * MAX_FILESIZE_TO_UPLOAD , type:'application/json'});
var urlencodedParser = bodyParser.urlencoded({ extended:true,limit:1024*1024* MAX_FILESIZE_TO_UPLOAD ,type:'application/x-www-form-urlencoded' });
app.use(jsonParser)
